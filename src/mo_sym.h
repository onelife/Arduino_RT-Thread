...
ADD_MODULE_SYM(rt_tick_from_millisecond, rt_tick_t, rt_int32_t ms)
...
ADD_MODULE_SYM(rt_object_get_information, struct rt_object_information *, enum rt_object_class_type type)

ADD_MODULE_SYM(rt_enter_critical, void, void)
ADD_MODULE_SYM(rt_critical_level, rt_uint16_t, void)

ADD_MODULE_SYM(rt_thread_init, rt_err_t, struct rt_thread *thread, const char *name, void (*entry)(void *parameter),
    void *parameter, void *stack_start, rt_uint32_t stack_size, rt_uint8_t priority, rt_uint32_t tick)
...
#ifdef RT_USING_HEAP
ADD_MODULE_SYM(rt_thread_create, rt_thread_t, const char *name, void (*entry)(void *parameter), void *parameter,
...
ADD_MODULE_SYM(rt_thread_control, rt_err_t, rt_thread_t thread, int cmd, void *arg)
...
ADD_MODULE_SYM(rt_timer_init, void, rt_timer_t timer, const char *name, void (*timeout)(void *parameter),
    void *parameter, rt_tick_t time, rt_uint8_t flag)
ADD_MODULE_SYM(rt_timer_detach, rt_err_t, rt_timer_t timer)
#ifdef RT_USING_HEAP
ADD_MODULE_SYM(rt_timer_create, rt_timer_t, const char *name, void (*timeout)(void *parameter), void *parameter,
...
ADD_MODULE_SYM(rt_memmove, void *, void *dest, const void *src, rt_size_t n)
ADD_MODULE_SYM(rt_memcmp, rt_int32_t, const void *cs, const void *ct, rt_size_t count)
ADD_MODULE_SYM(rt_strstr, char *, const char *str1, const char *str2)
ADD_MODULE_SYM(rt_strcasecmp, rt_int32_t, const char *a, const char *b)
ADD_MODULE_SYM(rt_strncpy, char *, char *dest, const char *src, rt_size_t n)
ADD_MODULE_SYM(rt_strncmp, rt_int32_t, const char *cs, const char *ct, rt_size_t count)
...
ADD_MODULE_SYM(rt_vsnprintf, rt_int32_t, char *buf, rt_size_t size, const char *fmt, va_list args)
ADD_MODULE_SYM(rt_snprintf, rt_int32_t, char *buf, rt_size_t size, const char *format, ...)
ADD_MODULE_SYM(rt_vsprintf, rt_int32_t, char *dest, const char *format, va_list arg_ptr)
...
ADD_MODULE_SYM(rt_kprintf, int, const char *fmt, ...)
#ifdef RT_DEBUG
ADD_MODULE_SYM(rt_assert_handler, void, const char *ex_string, const char *func, rt_size_t line)
#endif
...
ADD_MODULE_SYM(rt_memheap_init, rt_err_t, struct rt_memheap *memheap, const char *name, void *start_addr, rt_size_t size)
...
ADD_MODULE_SYM(rt_memheap_realloc, void *, struct rt_memheap *heap, void *ptr, rt_size_t newsize)
...
# ifdef RT_USING_HEAP
ADD_MODULE_SYM(rt_mp_create, rt_mp_t, const char *name, rt_size_t block_count, rt_size_t block_size)
...
ADD_MODULE_SYM(rt_mutex_init, rt_err_t, rt_mutex_t mutex, const char *name, rt_uint8_t flag)
...
ADD_MODULE_SYM(rt_sem_init, rt_err_t, rt_sem_t sem, const char *name, rt_uint32_t value, rt_uint8_t flag)
ADD_MODULE_SYM(rt_sem_detach, rt_err_t, rt_sem_t sem)
# ifdef RT_USING_HEAP
ADD_MODULE_SYM(rt_sem_create, rt_sem_t, const char *name, rt_uint32_t value, rt_uint8_t flag)
...
ADD_MODULE_SYM(rt_event_init, rt_err_t, rt_event_t event, const char *name, rt_uint8_t flag)
...
ADD_MODULE_SYM(rt_mb_send_wait, rt_err_t, rt_mailbox_t mb, rt_ubase_t value, rt_int32_t timeout)
ADD_MODULE_SYM(rt_mb_recv, rt_err_t, rt_mailbox_t mb, rt_ubase_t *value, rt_int32_t timeout)
...
ADD_MODULE_SYM(rt_mq_recv, rt_err_t, rt_mq_t mq, void *buffer, rt_size_t size, rt_int32_t timeout)
ADD_MODULE_SYM(rt_mq_control, rt_err_t, rt_mq_t mq, int cmd, void *arg)
#endif

#ifdef RT_USING_DEVICE
ADD_MODULE_SYM(rt_device_register, rt_err_t, rt_device_t dev, const char *name, rt_uint16_t flags)
...
ADD_MODULE_SYM(rt_device_read, rt_size_t, rt_device_t dev, rt_off_t pos, void *buffer, rt_size_t size)
ADD_MODULE_SYM(rt_device_write, rt_size_t, rt_device_t dev, rt_off_t pos, const void *buffer, rt_size_t size)
ADD_MODULE_SYM(rt_device_control, rt_err_t, rt_device_t dev, int cmd, void *arg)
ADD_MODULE_SYM(rt_device_set_rx_indicate, rt_err_t, rt_device_t dev, rt_err_t (*rx_ind)(rt_device_t dev, rt_size_t size))
ADD_MODULE_SYM(rt_device_set_tx_complete, rt_err_t, rt_device_t dev, rt_err_t (*tx_done)(rt_device_t dev, void *buffer))
#endif

#ifdef RT_USING_DFS
ADD_MODULE_SYM(dfs_subdir, const char *, const char *directory, const char *filename)
ADD_MODULE_SYM(dfs_normalize_path, char *, const char *directory, const char *filename)
...
#ifdef RT_USING_ULOG
ADD_MODULE_SYM(ulog_output, void, rt_uint32_t level, const char *tag, rt_bool_t newline, const char *format, ...)
#endif
