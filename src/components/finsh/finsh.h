...
# ifdef FINSH_USING_DESCRIPTION
#  ifdef __cplusplus
#   define MSH_FUNCTION_EXPORT_CMD(fn, alias, desc) \
    extern "C" const char __fsym_##fn##_name[] = #alias; \
    extern "C" const char __fsym_##fn##_desc[] = #desc;
#  else /* __cplusplus */
#   define MSH_FUNCTION_EXPORT_CMD(fn, alias, desc) \
    const char __fsym_##fn##_name[] = #alias; \
    const char __fsym_##fn##_desc[] = #desc;
#endif /* __cplusplus */
